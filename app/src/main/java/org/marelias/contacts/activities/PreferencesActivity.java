...
import static org.marelias.contacts.utils.PhoneCallUtils.getSimNames;
import static org.marelias.contacts.utils.PhoneCallUtils.hasMultipleSims;
import static org.marelias.contacts.utils.SharedPreferencesUtils.COMMON_SHARED_PREFS_FILE_NAME;
import static org.marelias.contacts.utils.SharedPreferencesUtils.DEFAULT_SIM_SELECTION_ALWAYS_ASK;
import static org.marelias.contacts.utils.SharedPreferencesUtils.DEFAULT_SIM_SELECTION_SYSTEM_DEFAULT;
import static org.marelias.contacts.utils.SharedPreferencesUtils.DEFAULT_SOCIAL_APP;
import static org.marelias.contacts.utils.SharedPreferencesUtils.ENABLE_CALL_FILTERING_SHARED_PREF_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.EXPORT_CONTACTS_EVERY_WEEK_SHARED_PREF_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.SHOULD_USE_SYSTEM_PHONE_APP;
import static org.marelias.contacts.utils.SharedPreferencesUtils.SIM_PREFERENCE_SHARED_PREF_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.SOCIAL_INTEGRATION_ENABLED_PREFERENCE_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.STORAGE_LOCATION;
import static org.marelias.contacts.utils.SharedPreferencesUtils.T9_PINYIN_ENABLED_SHARED_PREF_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.T9_SEARCH_ENABLED_SHARED_PREF_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.THEME_PREFERENCES_KEY;
import static org.marelias.contacts.utils.SharedPreferencesUtils.disableSocialIntegration;
import static org.marelias.contacts.utils.SharedPreferencesUtils.enableCallFiltering;
import static org.marelias.contacts.utils.SharedPreferencesUtils.enableSocialappIntegration;
import static org.marelias.contacts.utils.SharedPreferencesUtils.getDefaultSocialCountryCode;
import static org.marelias.contacts.utils.SharedPreferencesUtils.getPreferredSim;
...
public class PreferencesActivity extends AppBaseActivity {
    ...
    public static class PreferencesFragment extends PreferenceFragmentCompat {
        ...
        private void initExportPreferences() {
            ...
            autoExport.setOnPreferenceChangeListener((preference, enable) -> {
                if(U.isEqual(false, enable)) return true; // we let user disable the auto export, no questions asked
                if (hasExportLocation(getContext())) return true;
                Toast.makeText(getContext(), R.string.choose_create_export_location, LENGTH_SHORT).show();
                return false;
            });
            ...
            if(Build.VERSION.SDK_INT < 21) exportLocationPreference.setEnabled(false);
            exportLocationPreference.setOnPreferenceClickListener(preference -> {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) { // this preference is disabled for SDK < 21
                    pickADirectory(getActivity());
                }
                return true;
            });
        }
