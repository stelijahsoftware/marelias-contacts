...
import static org.marelias.contacts.data.datastore.ContactGroupsDataStore.computeGroupsAsync;
import static org.marelias.contacts.data.datastore.ContactsDBHelper.markContactAsTemporary;
import static org.marelias.contacts.data.datastore.ContactsDBHelper.unmarkContactAsTemporary;
...
import static org.marelias.contacts.interfaces.DataStoreChangeListener.ADDITION;
import static org.marelias.contacts.interfaces.DataStoreChangeListener.DELETION;
import static org.marelias.contacts.interfaces.DataStoreChangeListener.REFRESH;
...
public class ContactsDataStore {
    ...
    public static long addContact(VCard vCard, Context context) {
        org.marelias.contacts.orm.Contact newContactWithDatabaseId = ContactsDBHelper.addContact(vCard, context);
    ...
    @Nullable
    public static org.marelias.contacts.orm.Contact getContact(@NonNull String phoneNumber) {
    ...
    public static void addFavorite(org.marelias.contacts.orm.Contact contact) {
