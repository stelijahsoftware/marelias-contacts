...
import static org.marelias.contacts.orm.PhoneNumber.createDummyPhoneNumber;
import static org.marelias.contacts.utils.Common.getEmptyStringIfNull;
import static org.marelias.contacts.utils.Common.replaceAccentedCharactersWithEnglish;
import static org.marelias.contacts.utils.DomainUtils.getNumericKeyPadNumberForString;
...
public class Contact implements Serializable {
    ...
    public static Contact createNewDomainContact(org.marelias.contacts.orm.Contact contact, List<PhoneNumber> dbPhoneNumbers) {
        List<PhoneNumber> safePhoneNumbersList = dbPhoneNumbers == null ? Collections.emptyList() : dbPhoneNumbers;
        return new org.marelias.contacts.domain.Contact(contact.getId(), contact.firstName,
